...
################################################################################
## Form generated from reading UI file 'INTERFACE5.ui'
##
...
class Ui_MainWindow(object):
    ...
    def setup_camera(self):
        ...
        #self.iha_lat, self.iha_lon = 40.15124, 29.12142
        self.timer = QTimer()
    ...
    def display_video_stream(self):
        ...
        frame2 = cv2.resize(frame2,(600,550))
        frame3 = hedef_harita(self.ihalar,self.lat,self.lon)
        frame3 = cv2.resize(frame3,(600,550))

        frame = cv2.cvtColor(frame,  cv2.COLOR_BGR2RGB)
        frame = cv2.flip(frame, 1)

        frame = np.hstack((frame2, frame))
        frame = np.hstack((frame,frame3))
